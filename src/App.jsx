...
import VendorLogin from './pages/fun-day/vendor/VendorLogin'
import VendorRegister from './pages/fun-day/vendor/VendorRegister'
import VendorDashboard from './pages/fun-day/vendor/VendorDashboard'
import EventForm from './pages/fun-day/vendor/EventForm'
import EventBookings from './pages/fun-day/vendor/EventBookings'
import EventListing from './pages/fun-day/parent/EventListing'
  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/our-children" element={
          <ProtectedRoute>
            <OurChildren />
          </ProtectedRoute>
        } />
        <Route path="/fun-day" element={
          <ProtectedRoute>
            <EventListing />
          </ProtectedRoute>
        } />
        <Route path="/fun-day/events/:id" element={
          <ProtectedRoute>
            <EventDetails />
          </ProtectedRoute>
        } />
        <Route path="/fun-day/bookings" element={
          <ProtectedRoute>
            <ParentBookings />
          </ProtectedRoute>
        } />
        <Route path="/fun-day/my-registrations" element={<Navigate to="/fun-day/bookings" replace />} />
        ...
        <Route path="/fun-day/vendor/events/new" element={
          <VendorLayout>
            <EventForm />
          </VendorLayout>
        } />
        <Route path="/fun-day/vendor/events/:id/edit" element={
          <VendorLayout>
            <EventForm />
          </VendorLayout>
        } />
        <Route path="/fun-day/vendor/events/:id/bookings" element={
          <VendorLayout>
            <EventBookings />
          </VendorLayout>
        } />
