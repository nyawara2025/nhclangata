...
export const API_ENDPOINTS = {
  ...
  fundayGetEventDetails: `${getBaseUrl()}/fun-day/event-details`,
  ...
  // Parent Operations
  schoolTransportGetAssignment: `${getBaseUrl()}/school-transport/my-assignment`,
  schoolTransportGetTracking: `${getBaseUrl()}/school-transport/tracking-history`,
...
export const WEBHOOK_PATHS = {
  ...
  fundayGetEventDetails: "fun-day/event-details",
  ...
  // School Transport Operations
  schoolTransportGetAssignment: "school-transport/my-assignment",
  schoolTransportGetTracking: "school-transport/tracking-history",
  schoolTransportGetDelays: "school-transport/delays",
  schoolTransportDriverLogin: "school-transport/driver/login",
  schoolTransportDriverDashboard: "school-transport/driver/dashboard",
